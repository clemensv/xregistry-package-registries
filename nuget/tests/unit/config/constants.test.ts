...
describe('Application Constants', () => {
    ...
    describe('GROUP_CONFIG', () => {
        test('should have correct group configuration', () => {
            ...
            expect(GROUP_CONFIG.ID).toBe('nuget.org');
        });
    ...
    describe('NUGET_REGISTRY', () => {
        test('should have NuGet Registry configuration', () => {
            ...
            expect(NUGET_REGISTRY.USER_AGENT).toMatch(/xRegistry-NuGet-Wrapper\/\d+\.\d+/);
        });

        test('should use HTTPS for registry URLs', () => {
            expect(NUGET_REGISTRY.BASE_URL).toMatch(/^https:\/\/.*/);
            expect(NUGET_REGISTRY.SEARCH_URL).toMatch(/^https:\/\/.*/);
        });
