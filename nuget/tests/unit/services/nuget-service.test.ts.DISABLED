...
import { NuGetPackageManifest, NuGetService, NuGetVersionManifest } from '../../../src/services/nuget-service';
...
const createTempDir = (): string => {
    return fs.mkdtempSync(path.join(os.tmpdir(), 'nuget-service-test-'));
};
...
// Mock data
const mockPackageManifest: NuGetPackageManifest = {
    _id: 'express',
    name: 'express',
    ...
    versions: {
        '4.18.2': {
            ...
            dist: {
                ...
                tarball: 'https://registry.nuget.org/express/-/express-4.18.2.tgz',
                fileCount: 16,
                unpackedSize: 208736
            },
            _id: 'express@4.18.2',
            _nodeVersion: '16.17.1',
            _NuGetVersion: '8.15.0',
            _npmUser: {
                name: 'dougwilson',
...
const mockVersionManifest: NuGetVersionManifest = mockPackageManifest.versions['4.18.2']!;
...
describe('NuGet Service', () => {
    ...
    describe('constructor', () => {
        test('should create service with default config', () => {
            ...
            expect(service).toBeInstanceOf(NuGetService);
        });
        ...
        test('should configure axios instance correctly', () => {
            expect(mockedAxios.create).toHaveBeenCalledWith({
                ...
                timeout: 30000,
                headers: {
                    'User-Agent': 'xRegistry-NuGet-Wrapper/1.0',
    ...
    describe('getPackageMetadata', () => {
        test('should fetch and convert package metadata', async () => {
            ...
            const result = await service.getPackageMetadata('express');
        ...
        test('should handle scoped packages', async () => {
            ...
            const result = await service.getPackageMetadata('@types/node');
        ...
        test('should return cached data when available', async () => {
            ...
            const result1 = await service.getPackageMetadata('express');
            expect(result1).toBeDefined();

            // Second call - should use cache
            const result2 = await service.getPackageMetadata('express');
        ...
        test('should return null for non-existent package', async () => {
            ...
            const result = await service.getPackageMetadata('non-existent-package');
        ...
        test('should return null for non-200 response', async () => {
            ...
            const result = await service.getPackageMetadata('not-found');
    ...
    describe('getVersionMetadata', () => {
        test('should fetch and convert version metadata', async () => {
            ...
            const result = await service.getVersionMetadata('express', '4.18.2');
        ...
        test('should return cached version data when available', async () => {
            ...
            const result1 = await service.getVersionMetadata('express', '4.18.2');
            const result2 = await service.getVersionMetadata('express', '4.18.2');
        ...
        test('should return null for non-existent version', async () => {
            ...
            const result = await service.getVersionMetadata('express', '999.999.999');
    ...
    describe('getPackageTarball', () => {
        test('should fetch tarball data', async () => {
            ...
            const result = await service.getPackageTarball('express', '4.18.2');
        ...
        test('should return cached tarball when available', async () => {
            ...
            const result1 = await service.getPackageTarball('express', '4.18.2');

            // Second call - should use cache for tarball
            const result2 = await service.getPackageTarball('express', '4.18.2');
        ...
        test('should return null when version metadata not found', async () => {
            ...
            const result = await service.getPackageTarball('express', '999.999.999');
    ...
    describe('searchPackages', () => {
        ...
        test('should return null for failed search', async () => {
            ...
            const result = await service.searchPackages('invalid-query');
    ...
    describe('getDownloadStats', () => {
        test('should fetch download statistics', async () => {
            ...
            const result = await service.getDownloadStats('express', 'last-week');

            expect(result).toBeDefined();
            expect(result?.downloads).toBe(25000000);
            expect(result?.package).toBe('express');
            expect(mockAxiosInstance.get).toHaveBeenCalledWith(
                'https://api.nuget.org/downloads/point/last-week/express'
            );
        });
        ...
        test('should handle scoped packages in download stats', async () => {
            ...
            const result = await service.getDownloadStats('@types/node');

            expect(result).toBeDefined();
            expect(mockAxiosInstance.get).toHaveBeenCalledWith(
                'https://api.nuget.org/downloads/point/last-week/@types~node'
            );
        });
        ...
        test('should return null for failed stats request', async () => {
            ...
            const result = await service.getDownloadStats('non-existent');
    ...
    describe('packageExists', () => {
        test('should return true for existing package', async () => {
            ...
            const result = await service.packageExists('express');
        ...
        test('should return false for non-existent package', async () => {
            ...
            const result = await service.packageExists('non-existent');
    ...
    describe('versionExists', () => {
        test('should return true for existing version', async () => {
            ...
            const result = await service.versionExists('express', '4.18.2');
        ...
        test('should return false for non-existent version', async () => {
            ...
            const result = await service.versionExists('express', '999.999.999');
    ...
    describe('getRegistryStats', () => {
        test('should fetch registry statistics', async () => {
            ...
            const result = await service.getRegistryStats();
