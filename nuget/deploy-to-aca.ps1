# PowerShell script to deploy NuGet xRegistry to Azure Container Apps
...
param(
    ...
    [string]$AppName = "xregistry-nuget-bridge",
...
$imageName = "ghcr.io/$GitHubUsername/xregistry-package-registries/xregistry-nuget-bridge:$ImageTag"

# Set up environment variables
$envVars = "NODE_ENV=production PORT=$Port XREGISTRY_NUGET_PORT=$Port XREGISTRY_NUGET_BASEURL=$baseUrl XREGISTRY_NUGET_QUIET=false"

# Add API key if provided
if ($ApiKey) {
    $envVars = "$envVars XREGISTRY_NUGET_API_KEY=$ApiKey"
